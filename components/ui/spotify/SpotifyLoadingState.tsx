...
const SpotifyLoadingState = () => {
    return (
        <div className="relative">
            <div className="absolute inset-0 bg-green-600 rounded-lg blur-sm animate-scale"> </div>
            <div className="relative flex items-center w-auto h-24 px-5 space-x-5 bg-gray-900 rounded-lg md:w-96">
